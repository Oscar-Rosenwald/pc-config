{
  ...
  outputs = { self, nixpkgs, home-manager, ... }@inputs: 
    let
      ...
      customConfig      = inputs.myConfigDir;
    ...
    in {
      nixosConfigurations = 
        # concatMapAttrs takes the set hardwareConfig, and calls
        # buildHostConfiguration on each of its attributes. The result is a list
        # of sets, which are merged.
		#
